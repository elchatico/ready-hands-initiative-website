        ...
        <AnimatedSection>
          <div className="text-center">
            ...
            <p className="mt-4 max-w-3xl mx-auto text-lg text-gray-600">
              Founded in [Replace year], RHI began as a grassroots program to train junior high students. Today, we partner with schools and companies to build safer communities across the nation.
            </p>
          </div>
        </AnimatedSection>
